...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-20 bg-purple-300">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {experiences[activeTab as keyof typeof experiences].map((exp, index) => (
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-2 text-gray-600 bg-white px-4 py-2 rounded-lg">
                    <Calendar size={16} />
          ...
          <div className="text-center mt-12">
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-teal-700 transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
